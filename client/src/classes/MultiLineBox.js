 ...
 *
 */
MultiLineBox = cc.ControlButton.extend({
...
MultiLineBox.getRect = function (node) {
 ...
 * @param {cc.Color3B | cc.Scale9Sprite } normal9SpriteBg
 */
MultiLineBox.create = function (size, normal9SpriteBg, press9SpriteBg, disabled9SpriteBg) {
    var edbox = new MultiLineBox(size);
