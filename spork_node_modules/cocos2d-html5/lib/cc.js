...
function ResLoader(baseCfg){
    ...
    this._loadJsImg = function(){
        ...
        if(!jsLoadingImg){
            ...
            jsLoadingImg.src = "data:image/gif;base64,";

            var canvasNode = document.getElementById(document["ccConfig"].tag);
            canvasNode.style.backgroundColor = "rgba(0,0,0,0)";//"#"+document['ccConfig']['palette']['colour_paper'];
    ...
    this.loadGame = function(){
        var self = this;
        this._loadJsList4Dependency("", [baseCfg.modluesPathMap[baseCfg.projName] + baseCfg.resPath, "config.js"], 0, function(){
